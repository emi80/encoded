        ...
        return (
            <div className={itemClass}>
                ...
                {Object.keys(documents).length ?
                    <div className="panel" data-test="protocols">
...
var AssayDetails = module.exports.AssayDetails = function (props) {
    ...
    return (
        <div className="panel" data-test="panel-assay">
            <div className="panel-heading">
                <h3>Assay details</h3>
            </div>
            <div className="panel-body">
...
var Replicate = module.exports.Replicate = function (props) {
    ...
    return (
        <div key={props.key} className="panel" data-test="panel-replicate">
            <div className="panel-heading">
