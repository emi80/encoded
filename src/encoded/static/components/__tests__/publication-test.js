...
describe('Publication', function() {
    ...
    describe('Publication without references', function() {
        ...
        it('has a good abstract with an h4 and a p', function() {
            var panel = TestUtils.findRenderedDOMComponentWithClass(publication, 'panel-body').getDOMNode();
 
            var abstract = panel.querySelector('[data-test="abstract"]');
            var abstractPart = abstract.getElementsByTagName('h4');
